...
import { ArrowLeft, Edit, Trash2, Tag, BookOpen, Calendar, Activity } from "lucide-react";
...
const CategoryDetail = () => {
  ...
  if (!category) return <div className="text-gray-600 p-4">Category not found</div>;
              ...
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <p className="text-gray-900 bg-gray-50 p-3 rounded-md">{category.name}</p>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Slug
                    </label>
                    <p className="text-gray-900 bg-gray-50 p-3 rounded-md">{category.slug}</p>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      ID
                    </label>
                    <p className="text-gray-900 bg-gray-50 p-3 rounded-md">{category.id}</p>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Created By
                    </label>
                    <p className="text-gray-900 bg-gray-50 p-3 rounded-md">{category.created_by || 'N/A'}</p>
                  </div>
                </div>
                <div className="mt-6">
                  <label className="block text-sm font-medium text-gray-700 mb-2">
              ...
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-semibold text-gray-900 text-sm">{category.slug}</span>
                  </div>
                </div>
              </div>
